class PicksController < ApplicationController
  ...
  def import
    Pick.import(params[:file])
    redirect_to picks_path, notice: "Import Succesfully Completed"
  end
  ...
  private
    ...
    def pick_params
      params.require(:pick).permit(:first_name, :last_name, :prize_id)
    end
end
